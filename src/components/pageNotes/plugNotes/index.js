...
const mopiks = [
    {
        _id: "1",
        text: `1. Привет!! Это проект Компик Тишки. \n\nДа, он так называется. Придумал его Вова и разработал его тоже он, а его любимая половинка Аня помогала ему с этим. Все картинки и т.д. это она рисовала :)\n\nЧто за проект? Проект .чтобы делится своими чувствами , эмоциями, но при этом чтобы никто не знал кто ты и что ты. \nТы немо. Я немо.`
    },
    {
        _id: "2",
